...
area_de_trabalho = os.path.join(os.expanduser("~"), "Desktop")
caminho_arquivo = os.path.join(area_de_trabalho, "CadastroCliente", "cadastro_cliente.xlsx")
df_existente = pd.read_excel(caminho_arquivo)
df_novos = pd.DataFarme(clientes)
